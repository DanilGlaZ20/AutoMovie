...
namespace Auto.AuditLog
{
    class Program
    {
        ...
        {
            var csv =
                $"{message.FirstName},{message.LastName},{message.Age},{message.Town},{message.Address},{message.RegCodeVehicle},{message.CreatedAt}";
        ...
        {
            var csv =
                $"{message.Address},old:{message.OldVehicle},new:{message.NewVehicle},{message.CreatedAt}";
            Console.WriteLine(csv);
        }
